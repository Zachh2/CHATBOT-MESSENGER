...
<a href="https://www.npmjs.com/package/desuni"><img alt="npm version" src="https://img.shields.io/npm/v/desuni.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/desuni/desuni?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/desuni"><img src="https://img.shields.io/npm/dm/desuni.svg?style=flat-square" alt="npm downloads"></a>
...
## Install
If you just want to use desuni, you should use this command:
```bash
npm install desuni
```
It will download `desuni` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install desuni/desuni
```
